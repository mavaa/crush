...
type Options struct {
	...
	ShowOnlyConfiguredProviders bool         `json:"show_only_configured_providers,omitempty" jsonschema:"description=Only show configured providers in the model selection dialog outside onboarding,default=false"`
